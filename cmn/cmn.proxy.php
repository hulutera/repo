...
function help()
{
	echo '
			...
			src="http://static.katomer.com/img/register.png">
			</p>
			...
			<p>
			<img style="margin-left:10%;border:2px solid orange;width:80%"
			src="http://static.katomer.com/img/login.png">
			</p>
			</div>
			<div
			style="background-color: #f1f1f1; border-bottom: 1px solid #ccc; font-family: Georgia, Times New Roman, serif !important;"
			...
			src="http://static.katomer.com/img/items.png">
			</p>
			...
			src="http://static.katomer.com/img/removeImage.png"> to
			...
			src="http://static.katomer.com/img/removeImage.png"> ይጫኑ.
			...
			<p>
			<img style="margin-left:10%;width:80%;border:2px solid orange"
			src="http://static.katomer.com/img/contactus.png">
			</p>
			...
			src="http://static.katomer.com/img/search_help_2.png">
			<p class="helpEnglish" style="margin-left: 10px;">
			<strong>Step 2: </strong>
			</p>
			<p class="helpAmharic" style="margin-left: 10px;">
