...
function routerContent($contentType)
{
	...
	switch($contentType)
	{
		case 'deletedItems':  $isValidUrl = true;break;
		case 'pendingItems':  $isValidUrl = true;break;
		case 'reportedItems': $isValidUrl = true;break;
		case 'userActive':    $isValidUrl = true;break;
		case 'userPending':   $isValidUrl = true;break;
		case 'userMessages':  $isValidUrl = true;break;
	}
	...
	switch($contentType)
	{
		case 'deletedItems':  deletedItems(); break;
		case 'pendingItems':  pendingItems(); break;
		case 'reportedItems': reportedItems();break;
		case 'userActive':    userActive();   break;
		case 'userPending':   userPending();  break;
	}
}
