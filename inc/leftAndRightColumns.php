...
<li> <a href="#">Car</a>
    ...
    <ul id ="submenu">
		...
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Truck\',\'car\')">Truck</a></li>
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Mini_bus\', \'car\')">Mini_bus</a></li>
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Station Wagon\', \'car\')">Station Wagon</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Heavy Machine\', \'car\')">Heavy Machine</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Full Size Van\', \'car\')">Full Size Van</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Hatch back\', \'car\')">Hatch back</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Lift back\', \'car\')">Lift back</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Compact Car\', \'car\')">Compact Car</a></li>
        <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Sport Car\', \'car\')">Sport Car</a></li>
...
<li><a href="#">House</a>
	<ul id ="submenu">
		...
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Residential Rental\', \'house\')">Residential Rental</a></li>
	    <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Commercial\', \'house\')">Commercial</a></li>
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Land\', \'house\')">Plots of Land</a></li>
	</ul>
</li>
';
}
...
<li><a href="#">Computer</a>
	<ul id ="submenu">
		...
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Stationary\', \'computer\')">Stationary</a></li>
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Notebook\', \'computer\')">Notebook</a></li>
		<li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Workstations\', \'computer\')">Workstations</a></li>
	</ul>
</li>
';
}
...
<li> <a href="#">Electronics</a>
	<ul id ="submenu">
	    ...
	    <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Camera\', \'electronics\')">Camera</a></li>
	    <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Fridge\', \'electronics\')">Fridge</a></li>
	    <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Watch\', \'electronics\')">Watchs</a></li>
	    <li><a href="javascript:void(0)" onclick="jsfunctionsubmenu(\'Tape/Radio\', \'electronics\')">Tape/Radio</a></li>
...
<!--#### RIGHT COLUMN ##### -->
	<div id="rightColumn">		
		<div class ="logo"><a href="../index.php"><img src="http://static.katomer.com/img/mytest2.gif"></a></div>
	</div>
';
}
?>
