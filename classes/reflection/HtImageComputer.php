...
/**
 * Class HtImageComputer
 * @extends MySqlRecord
 * @filesource HtImageComputer.php
*/

// namespace hulutera;

class HtImageComputer extends MySqlRecord
{
    /**
    ...
    /**
     * Class attribute for mapping the primary key id of table image_computer
     *
    ...
    /**
     * Class attribute for storing the SQL DDL of table image_computer
     * @var string base64 encoded string for DDL
     */
    private $ddl = "";
    ...
    /**
     * Gets DDL SQL code of the table image_computer
     * @return string
     * @category Accessor
     */
    ...
    */
    ...
    /**
     * The HtImageComputer constructor
     *
     * It creates and initializes an object in two way:
     *  - with null (not fetched) data if none $id is given.
     *  - with a fetched data row from the table image_computer having id=$id
     * @param int $id. If omitted an empty (not fetched) instance is created.
     * @return HtImageComputer Object
     */
    ...
    /**
     * Fetchs a table row of image_computer into the object.
     *
     * Fetched table fields values are assigned to class attributes and they can be managed by using
     * the accessors/modifiers methods of the class.
     * @param int $id the primary key id value of table image_computer which identifies the row to select.
     * @return int affected selected row
     * @category DML
     */
    public function select($id)
    {
        $sql =  "SELECT * FROM image_computer WHERE id={$this->parseValue($id,'int')}";
    ...
    /**
     * Deletes a specific row from the table image_computer
     * @param int $id the primary key id value of table image_computer which identifies the row to delete.
     * @return int affected deleted row
     * @category DML
     */
    public function delete($id)
    {
        $sql = "DELETE FROM image_computer WHERE id={$this->parseValue($id,'int')}";
        $this->resetLastSqlError();
        $result = $this->query($sql);
        $this->lastSql = $sql;
        if (!$result) {
    ...
    /**
     * Insert the current object into a new table row of image_computer
     *
...
SQL;
    ...
    /**
     * Updates a specific row from the table image_computer with the values of the current object.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating of selected row.<br>
     * Null values are used for all attributes not previously setted.
     * @param int $id the primary key id value of table image_computer which identifies the row to update.
...
SQL;
    ...
    /**
     * Facility for updating a row of image_computer previously loaded.
     *
