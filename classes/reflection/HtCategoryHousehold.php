...
class HtCategoryHousehold extends MySqlRecord
{
    /**
    ...
    /**
     * Class attribute for mapping the primary key id of table category_household
     *
    ...
    /**
     * Class attribute for storing the SQL DDL of table category_household
     * @var string base64 encoded string for DDL
     */
    private $ddl = "Q1JFQVRFIFRBQkxFIGBjYXRlZ29yeV9ob3VzZWhvbGRgICgKICBgaWRgIGludCg0MCkgTk9UIE5VTEwgQVVUT19JTkNSRU1FTlQsCiAgYGZpZWxkX25hbWVgIHZhcmNoYXIoNDApIE5PVCBOVUxMLAogIFBSSU1BUlkgS0VZIChgaWRgKQopIEVOR0lORT1Jbm5vREIgQVVUT19JTkNSRU1FTlQ9NiBERUZBVUxUIENIQVJTRVQ9bGF0aW4x";
    ...
    /**
     * Gets DDL SQL code of the table category_household
     * @return string
     * @category Accessor
     */
    ...
    */
    ...
    /**
     * The HtCategoryHousehold constructor
     *
     * It creates and initializes an object in two way:
     *  - with null (not fetched) data if none $id is given.
     *  - with a fetched data row from the table category_household having id=$id
     * @param int $id. If omitted an empty (not fetched) instance is created.
     * @return HtCategoryHousehold Object
     */
    ...
    /**
     * Fetchs a table row of category_household into the object.
     *
     * Fetched table fields values are assigned to class attributes and they can be managed by using
     * the accessors/modifiers methods of the class.
     * @param int $id the primary key id value of table category_household which identifies the row to select.
    ...
    /**
     * Deletes a specific row from the table category_household
     * @param int $id the primary key id value of table category_household which identifies the row to delete.
    ...
    /**
     * Insert the current object into a new table row of category_household
     *
...
SQL;
    ...
    /**
     * Updates a specific row from the table category_household with the values of the current object.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating of selected row.<br>
     * Null values are used for all attributes not previously setted.
     * @param int $id the primary key id value of table category_household which identifies the row to update.
...
SQL;
    ...
    /**
     * Facility for updating a row of category_household previously loaded.
     *
