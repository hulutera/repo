...
class HtItemHouse extends MySqlRecord
{
    ...
    */
    ...
    public function searchQuery($start = null, $itemPerPage = null, $searchType)
    {
        ...
        $maxPriceFilter = $this->getMaxPriceFilter($this->maxPriceValue, 20000001);
    ...
    public function display()
    {
        ...
        if ($this->getidCategory() != null) {
            if ($this->getidCategory() != 6) {
                $houseCategory = $GLOBALS['upload_specific_array']['house']['idCategory'][2][$this->category($this->getIdCategory())];
