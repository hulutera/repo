...
class HtItemElectronic extends MySqlRecord
{
    ...
    */
    ...
    {
        $this->maxPriceValue = (isset($_GET['electronic_max_price'])) ? $_GET['electronic_max_price'] : "000";
        $this->typeValue = (isset($_GET['electronic_type'])) ? $_GET['electronic_type'] : "none";
    ...
    public function display()
    {
        ...
        if ($this->getIdCategory() != null) {
            if ($this->getIdCategory() != 8) {
                $elecCategory = $GLOBALS['upload_specific_array']['electronic']['idCategory'][2][$this->category($this->getidCategory())];
