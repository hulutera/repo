 ...
 * Class HtUserAdmin
 * @extends MySqlRecord
 * @filesource HtUserAdmin.php
 */

// namespace hulutera;

class HtUserAdmin extends MySqlRecord
{
    /**
    ...
    /**
     * Class attribute for mapping the primary key id of table user_admin
     *
    ...
    /**
     * Class attribute for storing the SQL DDL of table user_admin
     * @var string base64 encoded string for DDL
     */
    private $ddl = "";
    ...
    /**
     * Gets DDL SQL code of the table user_admin
     * @return string
     * @category Accessor
     */
    ...
    /**
     * The HtUserAdmin constructor
     *
     * It creates and initializes an object in two way:
     *  - with null (not fetched) data if none $id is given.
     *  - with a fetched data row from the table user_admin having id=$id
     * @param int $id. If omitted an empty (not fetched) instance is created.
     * @return HtUserAdmin Object
     */
    ...
    /**
     * Fetchs a table row of user_admin into the object.
     *
     * Fetched table fields values are assigned to class attributes and they can be managed by using
     * the accessors/modifiers methods of the class.
     * @param int $id the primary key id value of table user_admin which identifies the row to select.
    ...
    public function select($id)
    {
        if ($id == "*") {
            ...
            $sql =  "SELECT * FROM user_admin WHERE id={$this->parseValue($id, 'int')}";
        }
    ...
    /**
     * Deletes a specific row from the table user_admin
     * @param int $id the primary key id value of table user_admin which identifies the row to delete.
    ...
    /**
     * Insert the current object into a new table row of user_admin
     *
...
SQL;
    ...
    /**
     * Updates a specific row from the table user_admin with the values of the current object.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating of selected row.<br>
     * Null values are used for all attributes not previously setted.
     * @param int $id the primary key id value of table user_admin which identifies the row to update.
...
SQL;
    ...
    /**
     * Facility for updating a row of user_admin previously loaded.
     *
    ...
    /**
     * Facility for display a row for user_admin previously loaded.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating.
     * @category DML Helper
     * @return mixed MySQLi update result
    ...
    /**
     * Facility for upload a new row into user_admin.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating.
     * @category DML Helper
     * @return mixed MySQLi update result
