...
driver_path = '<copy the driver path here>'  ## copy the webdriver path here e.g: C:\Python34\chromedriver.exe
...
car_img = "<copy the car image path here>"     ## "sample image in HT_test_suite/upload_image/ford.jpg"
comp_img = "<computer image path>"    ## "sample image in HT_test_suite/upload_image/339365425_23590547-af46-4dd5-b8de-290f607fdf7b.jpg"
elec_img = "<electronics image path>"    ## "sample image in HT_test_suite/upload_image/20200628_150120.jpg"
house_img = "<house image path>"   ## "sample image in HT_test_suite/upload_image/image-0-02-01-8503f844bbb3e006e2062f7f5169d5dea3fad42081653f6ceadf7d740aa01b4c-V.jpg"
hh_img = "<household image path>"      ## "sample image in HT_test_suite/upload_image/image000000001.jpg"
phone_img = "<phone image path>"   ## "sample image in HT_test_suite/upload_image/iPhone-5-diagnose-rep-p.jpg"
other_img = "<others image path>"   ## "sample image in HT_test_suite/upload_image/20180224_105136 (1).jpg"