...
function computerSearch() {
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldPriceSell'][4].'</p>
			<select  class="col-xs-12 col-md-8" name="computer_max_price">';
			echo '<option value="000">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][3] .'</option>';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="computer_type">';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="computer_make">';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="computer_os">';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="computer_proc">';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="computer_hd">';
	...
	echo'<div class="col-xs-6 col-md-4 computer_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldColor'][0].'</p>
			<select  class="col-xs-12 col-md-8" name="computer_color">';
			echo '<option value="none">'. $GLOBALS['upload_specific_array']['common']['fieldColor'][1] .'</option>';
	 	   	    foreach ($colors as $key => $value) {
					echo '<option  style="background-color:' . $value[0] . ';color:'. $value[1].';width:90%">'. $GLOBALS['upload_specific_array']['common']['fieldColor'][2][$key] .'</option>';
		   	}
...
function phoneSearch() {
	...
	echo'<div class="col-xs-6 col-md-4 phone_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldPriceSell'][4].'</p>
			<select  class="col-xs-12 col-md-8" name="phone_max_price">';
			echo '<option value="000">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][3] .'</option>';
	...
	echo'<div class="col-xs-6 col-md-4 phone_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="phone_type">';
	...
	echo'<div class="col-xs-6 col-md-4 phone_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="phone_make">';
	...
	echo'<div class="col-xs-6 col-md-4 phone_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="phone_os">';
	...
	echo'<div class="col-xs-6 col-md-4 phone_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="phone_camera">';
...
function electronicSearch() {
	...
	echo'<div class="col-xs-6 col-md-4 electronic_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldPriceSell'][4].'</p>
			<select  class="col-xs-12 col-md-8" name="electronic_max_price">';
			echo '<option value="000">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][3] .'</option>';
	 	   	    foreach ($GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8] as $key => $value) {
					echo '<option value="'.$key.'">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8][$key] .'</option>';
		   	}
	...
	echo'<div class="col-xs-6 col-md-4 electronic_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="electronic_type">';
...
function householdSearch() {
	...
	echo'<div class="col-xs-6 col-md-4 household_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldPriceSell'][4].'</p>
			<select  class="col-xs-12 col-md-8" name="household_max_price">';
			echo '<option value="000">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][3] .'</option>';
	 	   	    foreach ($GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8] as $key => $value) {
					echo '<option value="'.$key.'">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8][$key] .'</option>';
		   	}
	...
	echo'<div class="col-xs-6 col-md-4 household_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="household_type">';
			echo '<option value="none">'. $GLOBALS['upload_specific_array']['electronic']['idCategory'][1] .'</option>';
...
function otherSearch() {
	...
	echo'<div class="col-xs-6 col-md-4 other_search_cl se-el hide">
			<p > '.$GLOBALS['upload_specific_array']['common']['fieldPriceSell'][4].'</p>
			<select  class="col-xs-12 col-md-8" name="other_max_price">';
			echo '<option value="000">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][3] .'</option>';
	 	   	    foreach ($GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8] as $key => $value) {
					echo '<option value="'.$key.'">'. $GLOBALS['upload_specific_array']['common']['fieldPriceSell'][8][$key] .'</option>';
		   	}
	...
	echo'<div class="col-xs-6 col-md-4 other_search_cl se-el hide">
			...
			<select  class="col-xs-12 col-md-8" name="other_type">';
...
?>
	...
	<?php echo $base_link . 'cities=Jijiga' . $str_url . '"><circle class="so-jij" cx="524" cy="278" r="10" fill="greenyellow"></circle><title>' . $lang['Jijiga'] . '</title></a>'; ?>
	<text x="524" y="300" class="so big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Jijiga']; ?></text>
	<text x="480" y="275" class="dd big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Dire Dawa']; ?></text>
	...
	<?php echo $base_link . 'cities=Asossa' . $str_url . '"><circle class="bn-aso" cx="105" cy="244" r="10" fill="greenyellow"></circle><title>' . $lang['Asossa'] . '</title></a>'; ?>
	<text x="105" y="264" class="bn big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Asossa']; ?></text>
	...
	<?php echo $base_link . 'cities=Addis Ababa' . $str_url . '"><circle class="or-add" cx="310" cy="321" r="12" fill="greenyellow"></circle><title>' . $lang['Addis Ababa'] . '</title></a>'; ?>
	<text x="310" y="340" class="or big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Addis Ababa']; ?></text>
	<?php echo $base_link . 'cities=Adama' . $str_url . '"><circle class="or-adm" cx="354" cy="376" r="10" fill="greenyellow"></circle><title>' . $lang['Adama'] . '</title></a>'; ?>
	<text x="354" y="393" class="or big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Adama']; ?></text>
	<?php echo $base_link . 'cities=Bishoftu' . $str_url . '"><circle class="or-bish" cx="334" cy="351" r="7" fill="greenyellow"></circle><title>' . $lang['Bishoftu'] . '</title></a>'; ?>
	<text x="334" y="365" class="or mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Bishoftu']; ?></text>
	<text x="490" y="320" class="dd mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Harar']; ?></text>
	<?php echo $base_link . 'cities=Asella' . $str_url . '"><circle class="or-ase" cx="374" cy="416" r="7" fill="greenyellow"></circle><title>' . $lang['Asella'] . '</title></a>'; ?>
	<text x="374" y="435" class="or mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Asella']; ?></text>
	<?php echo $base_link . 'cities=Jimma' . $str_url . '"><title>' . $lang['Jimma'] . '</title><circle class="or-jim" cx="200" cy="380" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="200" y="396" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Jimma']; ?></text>
	<?php echo $base_link . 'cities=Nekemte' . $str_url . '"><title>' . $lang['Nekemte'] . '</title><circle class="or-nek" cx="197" cy="315" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="197" y="331" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Nekemte']; ?></text>
	<?php echo $base_link . 'cities=Ambo' . $str_url . '"><title>' . $lang['Ambo'] . '</title><circle class="or-amb" cx="240" cy="320" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="240" y="310" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Ambo']; ?></text>
	<?php echo $base_link . 'cities=Shashemene' . $str_url . '"><title>' . $lang['Shashemene'] . '</title><circle class="or-sha" cx="300" cy="410" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="325" y="405" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Shashemene']; ?></text>
	...
	<?php echo $base_link . 'cities=Gambela' . $str_url . '"><title>' . $lang['Gambela'] . '</title><circle class="gm-gm" cx="77" cy="370" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="77" y="390" class="gm big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Gambela']; ?></text>
	...
	<?php echo $base_link . 'cities=Hawassa' . $str_url . '"><title>' . $lang['Hawassa'] . '</title><circle class="sn-awa" cx="288" cy="433" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="288" y="451" class="sn big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Hawassa']; ?></text>
	<?php echo $base_link . 'cities=Arba Minch' . $str_url . '"><title>' . $lang['Arba Minch'] . '</title><circle class="sn-arb" cx="230" cy="500" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="230" y="516" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Arba Minch']; ?></text>
	<?php echo $base_link . 'cities=Sodo' . $str_url . '"><title>' . $lang['Sodo'] . '</title><circle class="sn-sod" cx="245" cy="440" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="245" y="455" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Sodo']; ?></text>
	<?php echo $base_link . 'cities=Dila' . $str_url . '"><title>' . $lang['Dila'] . '</title><circle class="sn-dil" cx="288" cy="463" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="288" y="481" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Dila']; ?></text>
	<?php echo $base_link . 'cities=Hosaena' . $str_url . '"><title>' . $lang['Hosaena'] . '</title><circle class="sn-hos" cx="242" cy="415" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="245" y="429" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Hosaena']; ?></text>
	...
	<?php echo $base_link . 'cities=Asaita' . $str_url . '"><title>' . $lang['Asaita'] . '</title><circle class="af-asa" cx="445" cy="179" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="445" y="200" class="af big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Asaita']; ?></text>
	...
	<?php echo $base_link . 'cities=Axum' . $str_url . '"><title>' . $lang['Axum'] . '</title><circle class="ti-aux" cx="302" cy="40" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="302" y="54" class="ti mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Axum']; ?></text>
	<?php echo $base_link . 'cities=Mekele' . $str_url . '"><title>' . $lang['Mekele'] . '</title><circle class="ti-mek" cx="326" cy="62" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="336" y="82" class="ti big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Mekele']; ?></text>
	<?php echo $base_link . 'cities=Adigrat' . $str_url . '"><title>' . $lang['Adigrat'] . '</title><circle class="ti-adg" cx="348" cy="27" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="348" y="44" class="ti mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Adigrat']; ?></text>
	...
	<?php echo $base_link . 'cities=Gonder' . $str_url . '"><title>' . $lang['Gonder'] . '</title><circle class="am-gnd" cx="240" cy="133" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="240" y="148" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Gonder']; ?></text>
	<?php echo $base_link . 'cities=Bahir Dar' . $str_url . '"><title>' . $lang['Bahir Dar'] . '</title><circle class="am-bah" cx="228" cy="178" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="228" y="198" class="am big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Bahir Dar']; ?></text>
	<?php echo $base_link . 'cities=Dessie' . $str_url . '"><title>' . $lang['Dessie'] . '</title><circle class="am-des" cx="345" cy="202" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="345" y="218" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Dessie']; ?></text>
	<?php echo $base_link . 'cities=Debre Markos' . $str_url . '"><title>' . $lang['Debre Markos'] . '</title><circle class="am-debm" cx="266" cy="240" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="266" y="256" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Debre Markos']; ?></text>
	<?php echo $base_link . 'cities=Debre Birhan' . $str_url . '"><title>' . $lang['Debre Birhan'] . '</title><circle class="am-debb" cx="359" cy="289" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="359" y="304" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $lang['Debre Birhan']; ?></text>
