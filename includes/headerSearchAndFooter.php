...
function svgMapElement()
{
	...
	<text x="310" y="345" class="or big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Addis Ababa']; ?></text>
	<?php echo $base_link . 'cities=Adama' . $str_url . '"><circle class="or-adm" cx="354" cy="382" r="10" fill="greenyellow"></circle><title>' . $GLOBALS['city_lang_arr']['Adama'] . '</title></a>'; ?>
	<text x="354" y="400" class="or big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Adama']; ?></text>
	<?php echo $base_link . 'cities=Bishoftu' . $str_url . '"><circle class="or-bish" cx="334" cy="353" r="7" fill="greenyellow"></circle><title>' . $GLOBALS['city_lang_arr']['Bishoftu'] . '</title></a>'; ?>
	<text x="343" y="370" class="or mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Bishoftu']; ?></text>
	<?php echo $base_link . 'cities=Harar' . $str_url . '"><circle class="or-har" cx="490" cy="310" r="7" fill="greenyellow"></circle><title>' . $GLOBALS['city_lang_arr']['Bishoftu'] . '</title></a>'; ?>
	<text x="490" y="330" class="dd mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Harar']; ?></text>
	<?php echo $base_link . 'cities=Asella' . $str_url . '"><circle class="or-ase" cx="374" cy="446" r="7" fill="greenyellow"></circle><title>' . $GLOBALS['city_lang_arr']['Asella'] . '</title></a>'; ?>
	<text x="374" y="465" class="or mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Asella']; ?></text>
	...
	<text x="200" y="400" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Jimma']; ?></text>
	...
	<text x="197" y="335" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Nekemte']; ?></text>
	...
	<text x="230" y="519" class="sn big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Arba Minch']; ?></text>
	<?php echo $base_link . 'cities=Sodo' . $str_url . '"><title>' . $GLOBALS['city_lang_arr']['Sodo'] . '</title><circle class="sn-sod" cx="245" cy="445" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="245" y="465" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Sodo']; ?></text>
	...
	<text x="284" y="488" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Dila']; ?></text>
	...
	<text x="302" y="57" class="ti mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Axum']; ?></text>
	<?php echo $base_link . 'cities=Mekele' . $str_url . '"><title>' . $GLOBALS['city_lang_arr']['Mekele'] . '</title><circle class="ti-mek" cx="326" cy="70" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="345" y="92" class="ti big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Mekele']; ?></text>
	...
	<text x="240" y="153" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Gonder']; ?></text>
	...
	<text x="228" y="202" class="am big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Bahir Dar']; ?></text>
	...
	<text x="345" y="221" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Dessie']; ?></text>
	...
	<text x="266" y="259" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Debre Markos']; ?></text>
	...
	<text x="359" y="307" class="am mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Debre Birhan']; ?></text>
