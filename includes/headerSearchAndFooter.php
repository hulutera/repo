...
?>
	...
	<?php echo $base_link . 'cities=Hawassa' . $str_url . '"><title>' . $GLOBALS['city_lang_arr']['Hawassa'] . '</title><circle class="sn-awa" cx="288" cy="433" r="10" fill="greenyellow"></circle></a>'; ?>
	<text x="288" y="451" class="sn big-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Hawassa']; ?></text>
	...
	<text x="230" y="516" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Arba Minch']; ?></text>
	...
	<?php echo $base_link . 'cities=Dila' . $str_url . '"><title>' . $GLOBALS['city_lang_arr']['Dila'] . '</title><circle class="sn-dil" cx="288" cy="463" r="7" fill="greenyellow"></circle></a>'; ?>
	<text x="288" y="481" class="sn mid-city" text-anchor="middle" stroke="white" stroke-width="1px"><?php echo $GLOBALS['city_lang_arr']['Dila']; ?></text>
