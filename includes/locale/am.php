...
$lang = array(
    ...
    ይህ ስምምነት ከግንቦት 8 2012 ጀምሮ ተግባራዊ ሆኗል።<br/><br/>ይህንን የተጠቃሚ ስምምነት በማንኛውም ጊዜ የመቀየር መብት አለን ፤ በሚቀየርበት ወቅት በድሕረ ገጻችን ላይ እንገልጻለን። የተጠቃሚ ስምምነትን የማንበብም ሆነ ለውጡን የማየት የተጠቃሚው ሀላፊነት ነው።<br /><br />
...
$upload_specific_array = [
    ...
    'house' => [
        ...
        'fieldBuildYear'   => [
            ...
            2 => [
                '1940' => 'ከ 1940 በፊት',
                '1950' => 'በ 1940-1950 መካከል',
                '1960' => 'በ 1950-1960 መካከል',
                '1970' => 'በ 1970-1980 መካከል',
                'unlisted' => '-- አልተዘረዘረም --'
            ],
            3 => [
                '2011' => '2010 - 2012',
...
$user_specific_array = [
    ...
    'message' => [
        ...
        'password-recovery' => [
            ...
            'body' => [
                0 => 'ውድ ደንበኛችን፣<br>
                      አዲሲ የሚስጥር ቃል ለመቀየር ጠይቀውን ነበር። በዚህ መሰረት ከስር የሚያገኙት መሲብ በመጫን<br>
                      እና አዲሱን የሚስጥር ቃል በመጠቀም ከገቡ በኃላ የሚስጥር ቃል ለመቀየር የሚለውን መሲብ ተጠቅመው መቀየር ይችላሉ<br>
                      ይህ መልዕክት የተላከው ራስሰር(አውቶማቲክ) በሆነ የመልዕክት መላከያ መንገድ ስለሆነ የሚስጥር ቃሉን ለመቀየር የጠየቁ እርስዎ ካልሆኑ<br>
                      በዚህ የኢሜይል አድራሻ ይላኩልን <strong>admin@hulutera.com</strong><br>',
                1 => [
                    '<br>መሲብ:',
                    '<br>አዲሱ የሚስጥር ቃል:',
                    '<br>ከሰላምታ ጋር<br>የካቶመር አስተዳደር<br>'
                ],
            ]
        ],
        'edit-profile' => [
        ...
        'contact-us' => [
            ...
            'body' => [
                0 => 'መልእክትዎን ደርሶናል። ስለፃፉልንም እናመሰግናለን፡፡ ጥያቄዎ አስቸኳይ ከሆነ እባክዎን ከዚህ በላይ የተዘረዘሩትን የስልክ ቁጥሮች ተጠቅመው በመደወል ከሠራተኞቻችን ውስጥ አንዱን ያነጋግሩ።
...
$help = [
    ...
    1 => [
        ...
        "upload"   => [
            "head" => "ስለ ንብረት ማስገባት እንዴት እንደሚችሉ",
            "body" => [
        ...
        "contactus"   => [
            ...
            "body" => [
                ...
                "ተ.ቁ. 3" => "ቅፁን ከሞሉ በኃላ <button class='btn btn-primary'>ይላኩ</button> የሚላውን ይጫኑ። በመቀጠል <strong>ሊያገኙን ስለፈለጉ እናመሰግናለን</strong> የሚል መልዕክት ያገኛሉ።"
            ]
        ],
        "search"   => [
            "head" => "ስለ እንዴት መፈለግ እንደሚችሉ",
            "body" => [
                ...
                "ተ.ቁ. 3" => "በመቀጠል <button class='btn-warning'>ይፈለግ</button> የሚለውን ይጫኑ",
