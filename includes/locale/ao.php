...
$lang = array(
    ...
    'change language' => 'Afaan jijjiiruuf',
    "e-mail" => ' Imeelii ',
    ...
    "aboutus page paragraph2 text" => ' Hulluutaraan fedhii ummata akka guutuu yaadun website hojjatame dha, Itti fayyadamuf salphaa hoggaa ta’u haala barbaaddanin itti fayyadamu ni dandeessu. Qabeenya galchuf yoo yaaddana dursa galmaa’u qabdu. Galmeessicha haala salphaan raawwachu ni dandeessu. Qabeenya galchuufis ta’e qabeenya galchitan to’achuuf baayyee salphaa dha. Akkaataa itti fayyadamaa tarreeffaman yoo isin barbaachise odeefannoo isaa jedhu keessa bal’dhiinan ni argattu. ',
    "aboutus page paragraph3 text" => ' Yeroo ammati websiticha aafaan Ingiliffaan, Amaafriffaan, Oromiffaan, Tigiriffaan fi Somaaliffaan ilaalu kan dandeessaan gta’u illdee gara fulduratti afaan saboota adda addaa itti daballa. Namootni naannoo hunda keessa jiraatan weebsitichaatti fayyadamu ni danda’u. Abbaa qabeenyichaaf dhaamsa ergun ykn bilbila bilbiluun waa’ee qabeenyicha osoo eenyuu iyyuu gidduu hin galin marii’achu ni dandeessu. ',
    "aboutus page paragraph4 text" => ' Hulluutaraan nageenya odeefannoo qabeenyawan beeksiistaniif waan isaaf danda’ame hunda ni godha. Websiticha ilaalchisee gaaffiilee gosa kamiyyuu nu gaafachu ni dandeessu. Gaaffiilee keessaniif ariitiidhaan deebii ni kennina. Kanaaafuu akka nu gargaaruuf ',
    ...
    "pintrest" => 'Interest ',
    "youtube" => 'YouTube ',
    "2020 hulutera. All Rights Reserved." => ' Hulluutaraan mirgi isaa bara 2013 tti seeran kan eegame dha. ',
    ...
    "reply" => ' Deebisa ',
    "first page" => ' Fuula tokkoffaa ',
    "previous" => ' dura ',
    "next" => ' ittaanaa ',
    "last page" => ' Fuula dhuma ',
    ...
    "account activated message" => ' Akaawuntiin keessan hojiira waan oolef galuu ni dandeessu. Fuula akaawuntii keessan keessaa odeefannoo jijjiiruu, qabeenya galchuu fi qabeenya galchitan to’achuu ni dandeessu. ',
    ...
    'car' => [
        ...
        'idCategory'        => [
            ...
            2 => [
                ...
                "Convertible" => ' Baaxiin isaa kan banamu   ',
                "Full Size Van" => ' Vaan     ',
...
$user_specific_array = [
    'user' =>    [
        ...
        'fieldPurpose'       => [
            ...
            2 => [
                'General comment' => 'Yaada waliigalaa',
                'I can not find my Ad' => 'Qabeenyan galche argachuu hin dandeenye',
                'My Ad is not approved' => 'Qabeenyi ani galchee hin mirkanoofne',
                'My Ad is still pending' => 'qabeenyi ani galche active miti',
                'Technical problems in Ad' => 'Beeeksiisuf yammuun yaalu rakkoon teekniikaa na muddate jira.',
                'Problems with picture' => 'Fakkiin sirriitti hin mulatu',
                'I want to report suspected fraud' => 'Gabaasa gochaa waliindhawu gochuun barbaada',
                'Feedback and suggestions for hulutera' => 'Hulluutaraaf yaada kennuun barbaada',
            ]
        ],
    ],
    'message' => [
