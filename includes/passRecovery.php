			...
			<div id="main_section">
				...
				<!-- <div id="mainColumn">
					<form id="passrecovery" class="container" method="post" action="../includes/passRecovery.php">
						<div id="passR_title">
							<div class="passR_title_Eng">
								<p>To reset your password, please provide username or email.</p>
							</div>
							<div class="passR_title_Amh">
								<p>የምስጢር ቃልዎን ለማግኘት የመጠቀምያ ስምዎን ወይም ኢሜይልዎን ያስገቡ</p>
							</div>
						</div>
						<p class="errorPassRe" style="color:red;">
							<div id="usernameField">
								<div class="usernameText">
									<p>Username/የመጠቀምያ ስም</p>
								</div>
							...
							<div id="emailField">
								...
								<div class="emailInput"><input style="text-transform: lowercase;" type="text" class="input" id="email" name="email" maxlength="80" /></div>
							</div>
							<div id="PassRsubmit"><input type="submit" name="submit" id="submit" class="button" value="Submit" />
							</div>
					</form>
				</div> -->
			</div>
