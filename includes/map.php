...
function showMap()
{
	...
	echo '<!!----SVG for bigger screens----!!>
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="svg-big-sc" width="700" height="600" viewbox="0 0 1471.67 1150.63">';
	svgMapElement();
	echo '</svg>';
	echo '<!!----SVG for mid screens----!!>
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="svg-mid-sc" width="500" height="450" viewbox="0 0 1500 1400">';
	svgMapElement();
	echo '</svg>';
	echo '<!!----SVG for small screens----!!>
		<svg xmlns="http//www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="svg-small-sc" width="400" height="350" viewbox="0 0 1500 1400">';
	svgMapElement();
	echo '</svg>';
}
...
function svgMapElement()
{
	...
	echo '
    <defs>
        <style>.cls-1{fill:#f2e4df;stroke:#c49a6c;stroke-linecap:round;stroke-linejoin:round;}.cls-2{fill:#1c75bc;}.cls-3{font-size:33px;}.cls-3,.cls-6{font-family:Arial, Helvetica;font-weight:bold;}.cls-4{fill:#be4652;}.cls-5{letter-spacing:-0.02em;}.cls-6{font-size:38px;}</style>
    </defs>
