...
function location($hash)
{
	...
	echo '<option value = "Addis Ababa" ';
	if ($region == "Addis Ababa") echo " selected";
	echo '>' . $lang['Addis Ababa'] . '</option>';
	echo '<option value = "Dire Dawa" ';
	if ($region == "Dire Dawa") echo " selected";
	echo '>' . $lang['Dire Dawa'] . '</option>';
	echo '<option value = "Adama" ';
	if ($region == "Adama") echo " selected";
	echo '>' . $lang['Adama'] . '</option>';
	echo '<option value = "Bahir Dar" ';
	if ($region == "Bahir Dar") echo " selected";
	echo '>' . $lang['Bahir Dar'] . '</option>';
	echo '<option value = "Mekele" ';
	if ($region == "Mekele") echo " selected";
	echo '>' . $lang['Mekele'] . '</option>';
	echo '<option value = "Awassa" ';
	if ($region == "Awassa") echo " selected";
	echo '>' . $lang['Awassa'] . '</option>';
	echo '<option value = "Asaita" ';
	if ($region == "Asaita") echo " selected";
	echo '>' . $lang['Asaita'] . '</option>';
	echo '<option value = "Debre Birhan" ';
	if ($region == "Debre Birhan") echo " selected";
	echo '>' . $lang['Debre Birhan'] . '</option>';
	echo '<option value = "Dessie" ';
	if ($region == "Dessie") echo " selected";
	echo '>' . $lang['Dessie'] . '</option>';
	echo '<option value = "Gonder" ';
	if ($region == "Gonder") echo " selected";
	echo '>' . $lang['Gonder'] . '</option>';
	echo '<option value = "Gambela" ';
	if ($region == "Gambela") echo " selected";
	echo '>' . $lang['Gambela'] . '</option>';
	echo '<option value = "Harar" ';
	if ($region == "Harar") echo " selected";
	echo '>' . $lang['Harar'] . '</option>';
	echo '<option value = "Asella" ';
	if ($region == "Asella") echo " selected";
	echo '>' . $lang['Asella'] . '</option>';
	echo '<option value = "Bishoftu" ';
	if ($region == "Bishoftu") echo " selected";
	echo '>' . $lang['Bishoftu'] . '</option>';
	echo '<option value = "Jimma" ';
	if ($region == "Jimma") echo " selected";
	echo '>' . $lang['Jimma'] . '</option>';
	echo '<option value = "Nekemte" ';
	if ($region == "Nekemte") echo " selected";
	echo '>' . $lang['Nekemte'] . '</option>';
	echo '<option value = "Shashemene" ';
	if ($region == "Shashemene") echo " selected";
	echo '>' . $lang['Shashemene'] . '</option>';
	echo '<option value = "Arba Minch" ';
	if ($region == "Arba Minch") echo " selected";
	echo '>' . $lang['Arba Minch'] . '</option>';
	echo '<option value = "Dila" ';
	if ($region == "Dila") echo " selected";
	echo '>' . $lang['Dila'] . '</option>';
	echo '<option value = "Hosaena" ';
	if ($region == "Hosaena") echo " selected";
	echo '>' . $lang['Hosaena'] . '</option>';
	echo '<option value = "Sodo" ';
	if ($region == "Sodo") echo " selected";
	echo '>' . $lang['Sodo'] . '</option>';
	echo '<option value = "Jijiga" ';
	if ($region == "Jijiga") echo " selected";
	echo '>' . $lang['Jijiga'] . '</option>';
	echo '<option value = "Axum" ';
	if ($region == "Axum") echo " selected";
	echo '>' . $lang['Axum'] . '</option>';
	echo '<option value = "Adigrat" ';
	if ($region == "Adigrat") echo " selected";
	echo '>' . $lang['Adigrat'] . '</option>';
	echo '<option value = "Ambo" ';
	if ($region == "Ambo") echo " selected";
	echo '>' . $lang['Ambo'] . '</option>';
	echo '<option value = "Debre Markos" ';
	if ($region == "Debre Markos") echo " selected";
	echo '>' . $lang['Debre Markos'] . '</option>';
	echo '<option value = "Other" ';
	if ($region == "Other") echo " selected";
	echo '>' . $lang['Other'] . '</option>';
	echo '</select>';
...
function currency($hash)
{
	...
	echo '<option value = "Birr"';
	if ($currency == "Birr") echo " selected";
	echo '>' . $lang['BIRR'] . '</option>';
	echo '<option value = "USD"';
	if ($currency == "USD") echo " selected";
	echo '>' . $lang['USD'] . '</option>';
	echo '</select>';
...
function contactMethod($hash)
{
	...
	echo '<option value="1"';
	if ($contact == "1") echo " selected";
	echo '>' . $lang['e-mail'] . '</option>';
	echo '<option value="2"';
	if ($contact == "2") echo " selected";
	echo '>' . $lang['phone'] . '</option>';
	echo '<option value="3"';
	if ($contact == "3") echo " selected";
	echo '>' . $lang['with both'] . '</option>';
	echo '</select>';
